...
- **Test**: `dotnet test FSharp.Azure.Cosmos.slnx`
- **Important**: Integration tests require a running **Azure Cosmos DB Emulator**. If the emulator is not available in the CI environment, document this clearly in the Test Status section — do not treat it as a test failure caused by your changes.
